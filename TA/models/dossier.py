...
class Dossier(models.Model):
    ...
    ('680','680 EXPORTATION DEFINITIVE EN REGULARISATION D’EXPORTATION TEMPORAIRE POUR PERFECTIONNEMENT PASSIF (ETPP) OU D’EXPORTATION TEMPORAIRE (ET)'),
